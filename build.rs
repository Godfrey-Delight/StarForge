...
const SUBCOMMAND_INFO: &[(&str, &str)] = &[
    ...
    ("autocomplete", "Smart autocomplete — suggest and record commands"),
    ...
    ("diagnostics", "Run connectivity diagnostics for Ledger/Trezor devices"),
    ...
    ("optimize", "Analyse and optimize compiled WASM / Rust contract source"),
    ("ai-security-training", "AI-driven security training"),
    ("contract-monitor", "Contract health monitoring and alerting"),
